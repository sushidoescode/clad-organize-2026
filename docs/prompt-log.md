...
- **Agents/skills:** inline production (PreviewInteractTool choreography, MovePreviewCamera framing, screencapture, ffmpeg pipeline, ElevenLabs API, headless-Chrome card rendering); frame/log inspection as the verification loop for every take and draft.
