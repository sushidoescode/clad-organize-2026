...
|---|---|---|
| 0–5 s | Base view: subject pillar, red arc, axis line, tray, hint text visible | "I shoot documentaries. Standing in the room before an interview, the question is always: **which angles am I still missing?**" |
| 5–13 s | Drag wide wedge to −45°. Sectors flash green + ticks; hint fades | "This is Shot Coverage Compass, on SPECS. Every camera setup I place covers part of a ring around my subject…" |
...
| 20–27 s | Slow orbit while tapping a wedge twice (footprint shrinks/grows) | "Tap a wedge to change the shot — wide, medium, close. Coverage math follows." |
| 27–35 s | Drag a wedge across the axis line — line flares amber, warning buzz, status "Crossed the line!" | "And if I drift behind my subject — that's the 180° rule breaking, before it costs me the edit." |
| 35–42 s | Drag it back; final gap closes: full green arc, chime, subject pulse, "Coverage complete" | "When the arc closes, my coverage is complete. It remembers the layout for tomorrow's shoot." |
